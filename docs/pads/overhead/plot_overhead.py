...
def start():
    ...
    plt.errorbar(x_axis_vals_dist_2_board,
                 ...
                 label = 'Pause Operation on 2 Banana Pis',
    ...
    plt.errorbar(x_axis_vals_dist_2_board,
                 ...
                 label = 'Resume Operation on 2 Banana Pis',
    ...
    plt.errorbar(x_axis_vals_dist_4_board,
                 ...
                 label = 'Pause Operation on 4 Banana Pis',
    ...
    plt.errorbar(x_axis_vals_dist_4_board,
                 ...
                 label = 'Resume Operation on 4 Banana Pis',
    ...
    #ax.set_xscale("log")
    #ax.set_yscale("log")
    plt.xlabel('Total Number of Virtual Time Processes', fontsize=14)
    plt.ylabel('Overhead of Pause and Resume Operations (Microseconds)', fontsize=14)
    plt.grid(True)
